...
@Parcelize
class Weather(var city: City = getDefaultCity(), var temperature: Int = 0, var feelsLike: Int = 0, var pressureMM: Int = 0, var icon: String = "ovc"):Parcelable

fun getDefaultCity() = City("Тюмень", 57.152200, 65.527200)
...
fun getRussianCities() = listOf(
    Weather(City("Тюмень", 57.152200, 65.527200), 5, 6),
